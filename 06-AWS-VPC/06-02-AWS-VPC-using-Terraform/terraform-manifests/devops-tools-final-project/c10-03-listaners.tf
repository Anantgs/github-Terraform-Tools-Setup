...
#   for_each = {
#     for inst_key, inst_value in module.ec2_public : inst_key => inst_value
#     if inst_value.tags_all["purpose"] == aws_lb_target_group.test[inst_value.tags_all["purpose"]].name
#   }

#   target_group_arn = aws_lb_target_group.test[each.value.tags_all["purpose"]].arn
